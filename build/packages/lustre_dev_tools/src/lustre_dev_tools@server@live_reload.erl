...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 69).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 80).
-spec init_socket(
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 95).
-spec loop_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())},
    mist@internal@websocket:websocket_connection(),
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 132).
-spec close_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())}
) -> nil.
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 195).
-spec loop_watcher(
    watcher_msg(),
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 266).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 250).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 150).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 138).

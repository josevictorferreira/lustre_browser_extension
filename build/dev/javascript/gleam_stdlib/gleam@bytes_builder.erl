...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 78).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 65).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 38).
-spec new() -> bytes_builder().
new() ->
    gleam_stdlib:identity([]).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 143).
-spec from_string(binary()) -> bytes_builder().
from_string(String) ->
    gleam_stdlib:wrap_list(String).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 94).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 154).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 164).
-spec from_bit_array(bitstring()) -> bytes_builder().
from_bit_array(Bits) ->
    gleam_stdlib:wrap_list(Bits).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 47).
-spec prepend(bytes_builder(), bitstring()) -> bytes_builder().
prepend(Second, First) ->
    gleam_stdlib:iodata_append(gleam_stdlib:wrap_list(First), Second).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 56).
-spec append(bytes_builder(), bitstring()) -> bytes_builder().
append(First, Second) ->
    gleam_stdlib:iodata_append(First, gleam_stdlib:wrap_list(Second)).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 130).
-spec concat_bit_arrays(list(bitstring())) -> bytes_builder().
concat_bit_arrays(Bits) ->
    gleam_stdlib:identity(Bits).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 184).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 177).
-spec to_bit_array(bytes_builder()) -> bitstring().
to_bit_array(Builder) ->
    erlang:list_to_bitstring(Builder).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bytes_builder.gleam", 212).
